...
describe('throttledGetDataFromApi', () => {
  test('should create instance with provided base url', async () => {
    ...
    expect(mockedAxiosCreate).toHaveBeenCalledWith({ baseURL: "https://jsonplaceholder.typicode.com" })
  });
  ...
  test('should return response data', async () => {
    ...
    expect(await throttledGetDataFromApi('testRelativePath')).toBe(responseData)
  });
});
